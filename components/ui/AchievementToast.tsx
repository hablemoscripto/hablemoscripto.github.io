...
function ToastItem({ toast, onDismiss }: { toast: { id: string; title: string; description: string; icon: string }; onDismiss: (id: string) => void }) {
    ...
    return (
        <motion.div
            ...
            className="pointer-events-auto flex items-center gap-3 bg-surface-1/95 backdrop-blur-sm border border-accent-500/30 rounded-xl px-4 py-3 shadow-lg shadow-accent-500/10 max-w-xs cursor-pointer"
        ...
        >
            ...
            <div className="min-w-0">
                <p className="text-xs text-accent-400 font-semibold uppercase tracking-wide">Logro desbloqueado</p>
