...
const EducationNavbar: React.FC<EducationNavbarProps> = ({ onNavigateHome, globalProgress, onOpenProgress, currentView }) => {
    ...
    <nav className="sticky top-0 z-40 bg-slate-950 border-b border-white/5">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-slate-900 border-b border-white/5 p-4 space-y-4 absolute w-full shadow-2xl z-50">
            ...
            <button onClick={onNavigateHome} className="w-full flex items-center gap-2 p-3 text-slate-400">
