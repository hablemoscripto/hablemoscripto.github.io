  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Educación cripto en español para Latinoamérica. Aprende Bitcoin, wallets, seguridad, análisis de mercado y DeFi con una ruta estructurada." />
        <meta property="og:title" content="Hablemos Cripto: Aprende Cripto con Criterio desde Cero" />
        <meta property="og:description" content="Una ruta estructurada para entender Bitcoin, wallets, seguridad, análisis de mercado y DeFi antes de arriesgar tu dinero." />
        <meta property="og:url" content="https://hablemoscripto.io" />
        <meta name="twitter:title" content="Hablemos Cripto: Aprende Cripto con Criterio desde Cero" />
        <meta name="twitter:description" content="Educación cripto para LATAM, con seguridad y gestión de riesgo primero." />
        ...
        <section id="mentoria" className="py-16 md:py-20 bg-navy-900/60 border-y border-white/5 scroll-mt-28">
          <div className="container max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-navy-300 max-w-2xl mx-auto mb-10">
              ...
              <span className="font-semibold text-white">Cripto Experto</span> suma acceso inmediato
              a la comunidad privada, una sesión personal de bienvenida y encuentros grupales
              mensuales a medida que crece la comunidad.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4 mb-10 text-left">
              {[
                ...
                {
                  label: 'Bienvenida privada',
                  title: 'Tu punto de partida',
                  body: 'Después de tu compra coordinamos una sesión privada para entender tus objetivos y orientarte dentro de la ruta.',
                },
                {
                  label: 'Comunidad privada',
                  title: 'Conversaciones con contexto',
                  body: 'Acceso inmediato como miembro fundador y encuentros grupales mensuales a medida que crece la comunidad.',
                },
              ].map((topic, i) => (
                <div
                  key={i}
            ...
            <p className="mt-6 text-sm text-navy-400">
              Si eliges Cripto Experto, te escribiré dentro de los próximos dos días hábiles para
            ...
            <div className="container max-w-4xl mx-auto px-6">
                ...
                <div className="space-y-4">
                    {[
                        ...
                        { q: '¿Hay garantía?', a: 'Sí. Tienes una garantía de 7 días. Si dentro de ese plazo sientes que el contenido no es para ti, escríbenos a soporte@hablemoscripto.io y te devolvemos el 100% de tu dinero, sin preguntas.' },
